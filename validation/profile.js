...
module.exports = function validateProfileInput(data) {
  ...
  // set null, undefined and such to a string, because Validator.isEmpty works only on strings
  ...
  // Check if it's empty, because it's not required -> it's okey for it to be empty
